...
public class Business_Account extends Account{
  ...
  String accountType){
    super(accountName,accountNumber,accountPhone,accountSSN,accountBalance,accountType);//calls constructor of super class
    setInterestRate(0);//set the interest rate for business account. NOT necessarily required since the default interest rate is already 0 for each account. But for emphaize and consistency sake
  }
}